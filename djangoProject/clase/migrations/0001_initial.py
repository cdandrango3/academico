# Generated by Django 3.2.4 on 2021-07-28 19:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alumno_materia', models.ManyToManyField(to='clase.estudiante')),
            ],
        ),
        migrations.CreateModel(
            name='periodo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apellido', models.CharField(default='', max_length=300)),
                ('edad', models.CharField(default='0', max_length=3)),
                ('celular', models.CharField(default='0', max_length=3)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='curso',
            name='alumno_curso',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clase.estudiante'),
        ),
        migrations.AddField(
            model_name='curso',
            name='docente_curso',
